<h2>3. Longest Substring Without Repeating Characters</h2><h3>Medium</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">Given a string <code style="user-select: auto;">s</code>, find the length of the <strong style="user-select: auto;">longest substring</strong> without repeating characters.</p>
